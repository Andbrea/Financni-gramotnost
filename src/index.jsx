        ...
        <Switch>
          ...
          <Route path="/deti">
            <PageLayout
              ...
              links={
                <>
                  <Link className="navigation-link" to="/deti/minceabankovky">
                    Mince a Bankovky
                  </Link>
                  <Link
                  ...
                  <Link className="navigation-link" to="/deti/platebnikarta">
                    Platební karta
                  </Link>
                  <Link className="navigation-link" to="/deti/kviz">
                    Kvíz
                  </Link>
                </>
              }
          ...
          <Route path="/teenageri">
            <PageLayout
              ...
              links={
                <>
                  <Link className="navigation-link" to="/teenageri">
                    Potřebuji vs chci
                  </Link>
                  <Link className="navigation-link" to="/teenageri/zdrojpenez">
                    Zdroj peněz
                  </Link>
                  <Link className="navigation-link" to="/teenageri/sporeni">
                    Spoření
                  </Link>
                  <Link
                    className="navigation-link"
