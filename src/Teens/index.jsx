            ...
            <Switch>
                <Route exact={true} path="/teenageri">
                    <Page
                        ...
                        path="../../assets/img/Teens-img/needs-wants.svg"
                        altName="Potřebuji vs chci"
                ...
                <Route path="/teenageri/zdrojpenez">
                    <Page
                        title="Zdroj peněz"
                        path="../../assets/img/Teens-img/money-source.svg"
                        altName="Zdroj peněz"
                ...
                <Route path="/teenageri/platebnikarta">
                    <Page
                        ...
                        path="../../assets/img/Teens-img/credit-card.svg"
                        altName="Platební karta"
